...
```bash
python -m pip install soullink_public-2.3.1-py3-none-any.whl
soullink init
soullink doctor
soullink webui
```
...
Official `v2.3.1` release assets are:

- `soullink_public-2.3.1-py3-none-any.whl`
- `soullink_public-2.3.1.tar.gz`
- `SHA256SUMS.txt`
...
# Windows PowerShell
Get-FileHash .\soullink_public-2.3.1-py3-none-any.whl -Algorithm SHA256
